          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ route('admin.daftar.anggaran') }}">Daftar Anggaran</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('admin.form.anggaran') }}">Pengajuan Anggaran</a></li>
              </ul>
            </div>
          </li>
